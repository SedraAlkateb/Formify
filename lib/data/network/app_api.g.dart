...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<Message1Response> login(String username, String password) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  Future<Message1Response> updateConference(
    ...
    _data.fields.add(MapEntry('description', description));
    _data.fields.add(MapEntry('address', address));
    _data.fields.add(MapEntry('start_date', start_date));
    _data.fields.add(MapEntry('end_date', end_date));
    _data.fields.add(MapEntry('is_active', is_active.toString()));
    final _options = _setStreamType<Message1Response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'conference-crud/update_conference.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<StatisticsForUsersAnswersBaseResponse> statisticsForUsersAnswers(
    ...
    final _options = _setStreamType<StatisticsForUsersAnswersBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Statistics/statistics_for_usersAnswers.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late StatisticsForUsersAnswersBaseResponse _value;
    try {
      _value = StatisticsForUsersAnswersBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<QuestionsStatisticsBaseResponse> getStatisticsForQuestionTypes(
    ...
    _data.fields.add(MapEntry('survey_id', survey_id.toString()));
    _data.fields.add(MapEntry('conference_id', conference_id.toString()));
    final _options = _setStreamType<QuestionsStatisticsBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Statistics/get_statistics_for_questionTypes.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late QuestionsStatisticsBaseResponse _value;
    try {
      _value = QuestionsStatisticsBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<GetAllUserForAppBaseResponse> getAllUsers() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllUserForAppBaseResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'users-crud/get_all_users.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllUserForAppBaseResponse _value;
    try {
      _value = GetAllUserForAppBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AllSpecificationBaseResponse> getAllSpecification() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AllSpecificationBaseResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'specification-crud/get_all_specification.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllSpecificationBaseResponse _value;
    try {
      _value = AllSpecificationBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SpecificationBaseResponse> addSpecification(String title) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('title', title));
    final _options = _setStreamType<SpecificationBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'specification-crud/add_specification.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SpecificationBaseResponse _value;
    try {
      _value = SpecificationBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AllSaveDataBaseResponse> getAllUsersForSync(int conferenceId) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('conference_id', conferenceId.toString()));
    final _options = _setStreamType<AllSaveDataBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'synchronize/get_all_usersForSync.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllSaveDataBaseResponse _value;
    try {
      _value = AllSaveDataBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<Message1Response> updatedSyncUsersAnswers(
    ...
    final _options = _setStreamType<Message1Response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'synchronize/Updated_SyncUsersAnswers.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<AddAndModifyBaseResponse> addOrModifyUsers(
    ...
    final _options = _setStreamType<AddAndModifyBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'synchronize/addOrModify_users.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddAndModifyBaseResponse _value;
    try {
      _value = AddAndModifyBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
