...
const String PREFS_KEY_IS_CONFERENCE = "PREFS_KEY_IS_CONFERENCE";
...
class AppPreferences {
  ...
  Future<bool> setIConference(bool isConference) async {
    await _sharedPreferences.setBool(PREFS_KEY_IS_CONFERENCE, isConference);
    return true;
  }

  bool? getIsConference() {
    return _sharedPreferences.getBool(PREFS_KEY_IS_CONFERENCE);
  }

  int isGame() {
    return _sharedPreferences.getInt(PREFS_KEY_GAME_OR_SURVEY) ?? 0;
  }
