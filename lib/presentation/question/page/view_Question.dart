...
class QuestionPreviewBuilder extends StatelessWidget {
  ...
  FormFieldValidator<dynamic>? _requiredIfNeeded({String? message}) {
    if (question.isRequired == true) {
      return FormBuilderValidators.required(errorText: message ?? "This question is required");
    }
    return null;
  }
    ...
    switch (question.type) {
      ...
      case QuestionType.email:
        return FormBuilderTextField(
          ...
          validator: FormBuilderValidators.compose([
            if (question.isRequired == true)
              FormBuilderValidators.required(errorText: "This question is required"),
      ...
      case QuestionType.multipleChoice:
        return FormBuilderRadioGroup<AnswerModel>(
          ...
          options: question.answers
              .map((a) => FormBuilderFieldOption(value: a, child: Text(a.title)))
              .toList(),
          validator: _requiredIfNeeded(),
        );
      ...
      case QuestionType.checkbox:
        return FormBuilderCheckboxGroup<AnswerModel>(
          ...
          validator: question.isRequired == true
              ? FormBuilderValidators.minLength(1, errorText: "Select at least one option")
              : null,
        );
            ...
            return Autocomplete<String>(
              ...
              fieldViewBuilder: (context, controller, focusNode, onSubmit) {
                ...
                return TextField(
                  ...
                  onChanged: field.didChange, // هذا فقط لربط قيمة الحقل داخل FormBuilderField
                );
              },
            );
          },
      ...
      case QuestionType.rating:
        return FormBuilderRatingBar(
          ...
          validator: question.isRequired == true
              ? (value) => (value == null || value == 0) ? "This question is required" : null
              : null,
        );
