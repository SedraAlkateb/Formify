  ...
  Widget build(BuildContext context) {
    ...
    return
      ...
      floatingActionButton: FloatingActionButton.extended(
        backgroundColor: Colors.black.withOpacity(0.50), // شفاف
        elevation: 0, // بدون ظل (اختياري)
        ...
        label: Row(
          children: [
            ...
            const Text( "Add Survey", style: TextStyle(fontWeight: FontWeight.bold), ),
          ],
        ),
                ...
                return InkWell(
                  onTap: () {
                    ...
                    BlocProvider.of<SurveyBloc>(context).add(
                      ViewSurveyByIdEvent(conference.surveys[index].id),
                    );
